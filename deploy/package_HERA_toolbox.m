...
% Author: Lukas von Erdmannsdorff
    ...
    opts.Description = 'HERA (Hierarchical-Compensatory, Effect-Size-Driven Ranking Algorithm) is a MATLAB toolbox designed to automate the objective comparison of algorithms, experimental conditions, or datasets across multiple quality metrics. 

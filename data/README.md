...
- **`examples/`**: Contains synthetic example datasets used for demonstration and testing purposes.
  - **`Example_1/`**: Contains data for Example 1.
    - `CNR.csv`: Contrast-to-Noise Ratio data.
    - `OC.csv`: Optical Contrast data.
    - `SNR.csv`: Signal-to-Noise Ratio data.
  - **`Example_2/`**: Contains data for Example 2.
  - **`Example_2_workflow/`**: Python workflow for Example 2 stability analysis.
    - `data/`: Input data for the workflow.
    - `results/`: Results generated by the workflow (stability curve).
    - `run_workflow.py`: Python script to run the workflow.
    - `requirements.txt`: Python dependencies.
  - **`results/`**: Contains results generated by HERA analysis on the synthetic datasets.
...
![Final Ranking](examples/results/HERA_Example_1/Final_Ranking_Example_1.png)
...
![Distribution of Bootstrap Ranks](examples/results/HERA_Example_1/Graphics/Ranking/Distribution_Bootstrap_Ranks_Example_1.png)
...
![Sankey Diagram](examples/results/HERA_Example_1/Graphics/Ranking/Sankey_Rank_Shifts_Example_1.png)
...
![Stability Curve](examples/Example_2_workflow/results/stability_curve.png)

#### Final Ranking 2

The final ranking of the methods based on the hierarchical-compensatory logic with the confidence interval.

![Final Ranking](examples/results/HERA_Example_2/Final_Ranking_Example_2.png)

#### Distribution of Bootstrap Ranks 2

This diagram displays the frequency of each rank achieved by the methods across the bootstrap samples, illustrating the uncertainty in the ranking.

![Distribution of Bootstrap Ranks](examples/results/HERA_Example_2/Graphics/Ranking/Distribution_Bootstrap_Ranks_Example_2.png)

#### Rank Shifts (Sankey Diagram) 2

This diagram shows how the ranking of methods changes across different metrics and their hierarchy level.

![Sankey Diagram](examples/results/HERA_Example_2/Graphics/Ranking/Sankey_Rank_Shifts_Example_2.png)

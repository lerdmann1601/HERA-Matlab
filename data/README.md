...
![Final Ranking](results/HERA_Example_1/Final_Ranking_Example_1.png)
...
![Distribution of Bootstrap Ranks](results/HERA_Example_1/Graphics/Ranking/Distribution_Bootstrap_Ranks_Example_1.png)
...
![Sankey Diagram](results/HERA_Example_1/Graphics/Ranking/Sankey_Rank_Shifts_Example_1.png)
...
![Final Ranking](results/HERA_Example_2/Final_Ranking_Example_2.png)

#### Distribution of Bootstrap Ranks 2

This diagram displays the frequency of each rank achieved by the methods across the bootstrap samples, illustrating the uncertainty in the ranking.

![Distribution of Bootstrap Ranks](results/HERA_Example_2/Graphics/Ranking/Distribution_Bootstrap_Ranks_Example_2.png)

#### Rank Shifts (Sankey Diagram) 2

This diagram shows how the ranking of methods changes across different metrics and their hierarchy level.

![Sankey Diagram](results/HERA_Example_2/Graphics/Ranking/Sankey_Rank_Shifts_Example_2.png)

#### Win-Loss Matrix 2

This matrix visualizes the pairwise comparisons between methods. Green indicates a win, red a loss, and gray neutral due to the Threshold criteria not being satisfied. The color intensity indicates the power of each comparison.

![Win-Loss Matrix](results/HERA_Example_2/Graphics/Ranking/Win_Loss_Matrix_Example_2.png)

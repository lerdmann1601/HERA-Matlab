...
%   The fallback version is currently defined as '1.0.1'. 
%   Please make sure to update this version if a new tag is created!
%
% Outputs:
%   version_str - (char) The version string (e.g., 'v1.0.1-2-g1234abc' or '1.0.1').
%
% Author: Lukas von Erdmannsdorff
    ...
    try
        ...
        [status, cmdout] = system('git describe --tags --always --dirty 2>&1');

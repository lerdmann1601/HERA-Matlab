            ...
            for b_loc = 1:num_batches_par
                 ...
                 for bb_b = 1:current_n_loc
                     ...
                     [~, bootstrap_rank] = HERA.calculate_ranking(...
                         all_data, es_struct, thresholds, config, dataset_names, pair_idx_all, lang, boot_indices_block(:, bb_b), ~has_nans_all);
...
parfor b_idx = 1:num_batches
    ...
    for k = 1:current_batch_size
        ...
        [~, rnk] = HERA.calculate_ranking(...
             all_data, es_struct, thresholds, config, dataset_names, pair_idx_all, lang, boot_indices_block(:, k), ~has_nans_all);
        batch_ranks(:, k) = rnk;
    end

...
clc;
    ...
    bs_thr = struct('B_start', 100, 'B_step', 100, 'B_end', 5000, 'n_trials', 30, 'min_steps_for_convergence_check', 3, 'smoothing_window', 3, ...
        'convergence_streak_needed', 3, 'convergence_tolerance', 0.005);    
    bs_bca = struct('B_start', 100, 'B_step', 200, 'B_end', 15000, 'n_trials', 25, 'min_steps_for_convergence_check', 3, 'smoothing_window', 4, ...
        'convergence_streak_needed', 3, 'convergence_tolerance', 0.02);     
    bs_rank = struct('B_start', 50, 'B_step', 10, 'B_end', 1000, 'n_trials', 20, 'min_steps_for_convergence_check', 3, 'smoothing_window', 3, ...
        'convergence_streak_needed', 3, 'convergence_tolerance', 0.005);    
